...
export default function ProjetoDetalhe() {
  ...
  const hasComparison = !!project.before && !!project.after
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
                ...
                <div className="relative rounded-xl overflow-hidden shadow-2xl bg-gray-100 aspect-video ring-1 ring-border/50">
                  {viewMode === 'split' ? (
                    ...
                    <div className="w-full h-full relative animate-fade-in">
                      <img
                        src={
                          viewMode === 'after' ? project.after : project.before
                        }
            ...
            {/* Gallery Section */}
            {(galleryImages.length > 0 || hasComparison) && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {[project.after, project.before, ...galleryImages]
